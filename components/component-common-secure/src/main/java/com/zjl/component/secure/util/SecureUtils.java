...
import com.zjl.component.secure.secure.BaseSecure;
...
public class SecureUtils {
     ...
     * @return
     */
    public static String encrypt(String value, String key, SecureType type, EncType contentEncType,
            EncType keyEncType) {
     ...
     * @return
     */
    public static String decrypt(String value, String key, SecureType type, EncType contentEncType,
            EncType keyEncType) {
        byte[] data = value.getBytes();
        BaseSecure secure = SecureFactory.getSecure(type, key);
        secure.setKeyEncType(keyEncType);
     ...
     * @return
     */
    public static String encryptRSAPrivate(String value, String privateKey, EncType contentEncType,
            EncType keyEncType) {
     ...
     * @return
     */
    public static String encryptRSAPublic(String value, String publicKey, EncType contentEncType,
            EncType keyEncType) {
     ...
     * @return
     */
    public static String decryptRSAPrivate(String value, String privateKey, EncType contentEncType,
            EncType keyEncType) {
     ...
     * @return
     */
    public static String decryptRSAPublic(String value, String publicKey, EncType contentEncType,
            EncType keyEncType) {
     ...
     * @return
     */
    public static String encryptDES(String value, String key, EncType contentEncType,
            EncType keyEncType) {
     ...
     * @return
     */
    public static String decryptDES(String value, String key, EncType contentEncType,
            EncType keyEncType) {
     ...
     * @return
     */
    public static String encrypt3DES(String value, String key, EncType contentEncType,
            EncType keyEncType) {
     ...
     * @return
     */
    public static String decrypt3DES(String value, String key, EncType contentEncType,
            EncType keyEncType) {
     ...
     * @return
     */
    public static String encryptAES(String value, String key, EncType contentEncType,
            EncType keyEncType) {
     ...
     * @return
     */
    public static String decryptAES(String value, String key, EncType contentEncType,
            EncType keyEncType) {
