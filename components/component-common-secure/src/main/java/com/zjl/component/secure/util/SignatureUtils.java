...
public class SignatureUtils {
     ...
     * @return
     */
    public static String getSignDES(String value, String key, EncType contentEncType,
            EncType keyEncType) {
     ...
     * @return
     */
    public static String getSign3DES(String value, String key, EncType contentEncType,
            EncType keyEncType) {
     ...
     * @return
     */
    public static String getSignAES(String value, String key, EncType contentEncType,
            EncType keyEncType) {
    ...
    public static String getSignRSA(String value, String privateKey) {
        return getSignRSA(value, privateKey, SecureType.SignAlgorithm.SHA256WithRSA, EncType.BASE64,
                EncType.BASE64);
    }
     ...
     * @return
     */
    public static String getSignRSA(String value, String privateKey, EncType contentEncType,
            EncType keyEncType) {
        return getSignRSA(value, privateKey, SecureType.SignAlgorithm.SHA256WithRSA, contentEncType,
                keyEncType);
    }
    ...
    public static String getSignRSA(String value, String privateKey, SecureType.SignAlgorithm type,
            EncType contentEncType, EncType keyEncType) {
        byte[] data = value.getBytes();
        RSAPrivateSecure secure = (RSAPrivateSecure) SecureFactory.getSecure(SecureType.RSA_PRIVATE,
                privateKey);
    ...
    /**
     * RSA  使用指定方法，指定加密key,默认编码,默认加签算法 验证
     *
     * @param value
     * @param publicKey
     * @return
    ...
    public static boolean verify(String value, String publicKey, String sign) {
        return verify(value, publicKey, sign, SecureType.SignAlgorithm.SHA256WithRSA,
                EncType.BASE64, EncType.BASE64);
    }

    /**
     * RSA 使用指定方法，指定加密key,默认编码，指定加签算法 验证
     *
     * @param value
     * @param publicKey
     * @param type
    ...
    /**
     * RSA 使用指定方法，指定加密key,指定编码(结果内容编码，key编码),默认加签算法 验证
     *
     * @param value
     * @param publicKey
     * @return
    ...
    public static boolean verify(String value, String publicKey, String sign,
            EncType contentEncType, EncType keyEncType) {
        return verify(value, publicKey, sign, SecureType.SignAlgorithm.SHA256WithRSA,
                contentEncType, keyEncType);
    }

    /**
     * RSA 使用指定方法，指定加密key,指定编码(结果内容编码，key编码),加签算法 验证
     *
     * @param value
     * @param sign
     * @param type
     ...
     */
    public static boolean verify(String value, String publicKey, String sign,
            SecureType.SignAlgorithm type, EncType contentEncType, EncType keyEncType) {
        byte[] data = value.getBytes();
        RSAPublicSecure secure = (RSAPublicSecure) SecureFactory.getSecure(SecureType.RSA_PUBLIC,
                publicKey);
        secure.setKeyEncType(keyEncType);
        secure.setContentEncType(contentEncType);
