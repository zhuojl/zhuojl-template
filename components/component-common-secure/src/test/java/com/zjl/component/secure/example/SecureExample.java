package com.zjl.component.secure.example;

import com.zjl.component.secure.common.EncType;
import com.zjl.component.secure.util.SecureUtils;
...
public class SecureExample {
    ...
    //mobileList=18781923592&__signature=139AF13DFAE24C4545CD9AFE0FA4679A&brandId=VW
    private static final String INPUT_STR = "18781923592$VW$uatfbccommon20220427";
    ...
    public static void main(String[] args) throws Exception {
        ...
        byte[] bytes = Base64.getEncoder().encode(INPUT_STR.getBytes("utf-8"));
        System.out.println(new String(bytes, "utf-8"));
        System.out.println(new String(Base64.getDecoder().decode(bytes)));
        ...
        System.out.println("RSA 私钥加密:" + SecureUtils.encryptRSAPrivate(INPUT_STR,
                privateKeyString));//私钥加密公钥解密
        System.out.println("RSA 公钥加密:" + SecureUtils.encryptRSAPublic(INPUT_STR,
                publicKeyString));//公钥加密私钥解密
        System.out.println("============================");
        System.out.println("使用指定方法，指定加密key,指定编码:");
        System.out.println(
                "DES HEX:" + SecureUtils.encryptDES(INPUT_STR, key, EncType.HEX, EncType.DEFAULT));
        System.out.println("DES BASE64:" + SecureUtils.encryptDES(INPUT_STR, key, EncType.BASE64,
                EncType.DEFAULT));
        //System.out.println("DES:" + SecureUtils.encryptDES(INPUT_STR, key, EncType.HEX,EncType.HEX));

        System.out.println("3DES HEX:" + SecureUtils.encrypt3DES(INPUT_STR, key, EncType.HEX,
                EncType.DEFAULT));
        System.out.println("3DES BASE64:" + SecureUtils.encrypt3DES(INPUT_STR, key, EncType.BASE64,
                EncType.DEFAULT));
        //System.out.println("DES3:" + SecureUtils.encrypt3DES(INPUT_STR, key, EncType.HEX,EncType.BASE64));
        System.out.println(
                "AES:" + SecureUtils.encryptAES(INPUT_STR, key, EncType.HEX, EncType.HEX));
        System.out.println(
                "RSA 私钥加密:" + SecureUtils.encryptRSAPrivate(INPUT_STR, privateKeyStringHex,
                        EncType.HEX, EncType.HEX));
        System.out.println(
                "RSA 公钥加密:" + SecureUtils.encryptRSAPublic(INPUT_STR, publicKeyStringHex,
                        EncType.HEX, EncType.HEX));
        ...
        System.out.println(
                "RSA 公钥解密:" + SecureUtils.decryptRSAPublic(strRSAPrivate, publicKeyString));
        System.out.println("RSA 私钥解密:" + SecureUtils.decryptRSAPrivate(strRSAPublic,
                privateKeyString));//公钥加密私钥解密
        System.out.println("============================");
        ...
        strRSAPrivate = SecureUtils.encryptRSAPrivate(INPUT_STR, privateKeyStringHex, EncType.HEX,
                EncType.HEX);
        strRSAPublic = SecureUtils.encryptRSAPublic(INPUT_STR, publicKeyStringHex, EncType.HEX,
                EncType.HEX);
        System.out.println(
                "DES:" + SecureUtils.decryptDES(strDES, key, EncType.HEX, EncType.DEFAULT));
        System.out.println(
                "DES3:" + SecureUtils.decrypt3DES(strDES3, key, EncType.HEX, EncType.DEFAULT));
        System.out.println("AES:" + SecureUtils.decryptAES(strAES, key, EncType.HEX, EncType.HEX));
        System.out.println(
                "RSA 公钥解密:" + SecureUtils.decryptRSAPublic(strRSAPrivate, publicKeyStringHex,
                        EncType.HEX, EncType.HEX));//私钥加密公钥解密
        System.out.println(
                "RSA 私钥解密:" + SecureUtils.decryptRSAPrivate(strRSAPublic, privateKeyStringHex,
                        EncType.HEX, EncType.HEX));//公钥加密私钥解密
