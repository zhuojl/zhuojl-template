...
import com.zjl.component.secure.secure.AESSecure;
import com.zjl.component.secure.secure.DES3Secure;
import com.zjl.component.secure.secure.DESSecure;
import com.zjl.component.secure.secure.MD5Secure;
import com.zjl.component.secure.secure.RSAPrivateSecure;
import com.zjl.component.secure.secure.RSAPublicSecure;
...
public class SecureTest {
    ...
    public void desTest() {
        ...
        try {
            byte[] data = INPUT_STR.getBytes();
            DESSecure codecA = (DESSecure) SecureFactory.getSecure(SecureType.DES,
                    "AAAAAAAAAAAAAAAA");
            ...
            System.out.println("decryptData hex DES:" + codecB.getDecrypt2Hex(
                    codecA.getEncrypt2Hex(data).getBytes()));
            System.out.println("decryptData base64 DES:" + codecB.getDecrypt2Base64(
                    "LN4koqnzOrj70kYdmXeO34egve7MHE/T".getBytes()));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void des3Test() {
        ...
        try {
            byte[] data = INPUT_STR.getBytes();
            DES3Secure codecA = (DES3Secure) SecureFactory.getSecure(SecureType.DES3,
                    "AAAAAAAAAAAAAAAA");
            String secretKey = codecA.getSecretKey();
            ...
            System.out.println("decryptData hex 3DES:" + codecB.getDecrypt2Hex(
                    codecA.getEncrypt2Hex(data).getBytes()));
            System.out.println("decryptData base64 3DES:" + codecB.getDecrypt2Base64(
                    codecA.getEncrypt2Base64(data).getBytes()));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void aesTest() {
        ...
        try {
            byte[] data = INPUT_STR.getBytes();
            AESSecure codecA = (AESSecure) SecureFactory.getSecure(SecureType.AES,
                    "AAAAAAAAAAAAAAAA");
            String secretKey = codecA.getSecretKey();
            ...
            System.out.println("decryptData hex AES:" + codecB.getDecrypt2Hex(
                    codecA.getEncrypt2Hex(data).getBytes()));
            System.out.println("decryptData base64 AES:" + codecB.getDecrypt2Base64(
                    "T5leeW3QFl82ZxIo/j1KVnNt3wAf6FFETFudjl+LnJg=".getBytes()));
    ...
    public void rsaTest() {
        ...
        try {
            ...
            RSAPublicSecure codecB = (RSAPublicSecure) SecureFactory.getSecure(
                    SecureType.RSA_PUBLIC, publicKeyString);
            ...
            RSAPrivateSecure codecA = (RSAPrivateSecure) SecureFactory.getSecure(
                    SecureType.RSA_PRIVATE, privateKeyString);
            //codecA.encType = EncType.BASE64;
            String privateKey = codecA.getPrivateKey();
            System.out.println("privateKey:" + privateKey);
            System.out.println("decrypt hex RSA:" + codecA.getDecrypt2Hex(
                    codecB.getEncrypt2Hex(data).getBytes()));
            System.out.println("decrypt base64 RSA:" + codecA.getDecrypt2Base64(
                    codecB.getEncrypt2Base64(data).getBytes()));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
