...
public class PageResponse<T> extends Response<Collection<T>> {
    ...
    public static <T> PageResponse<T> of(Collection<T> data, int totalCount, int pageSize,
            int pageIndex) {
        PageResponse<T> response = new PageResponse<>();
    ...
    public Collection<T> getData() {
        return Objects.isNull(super.getData()) ? Collections.emptyList()
                : new ArrayList<>(super.getData());
    }
