...
import com.zjl.component.common.exception.*;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public final ResponseEntity<Object> handleBizException(BizException e, WebRequest request) throws Exception {
        ...
        if (LOGGER.isErrorEnabled()) {
            LOGGER.error("handleBizException EXCEPTION: {}, errorMsg:{}", e.getClass().getSimpleName(), e.getMessage(), e);
        }
    ...
    public final ResponseEntity<Object> handleBadRequestException(BadRequestException e, WebRequest request) throws Exception {
        //在Debug的时候，对于BizException也打印堆栈
        if (LOGGER.isErrorEnabled()) {
            LOGGER.error("handleBadRequestException EXCEPTION: {}, errorMsg:{}", e.getClass().getSimpleName(), e.getMessage(), e);
        }
        return new ResponseEntity<>(Response.failure(e), HttpStatus.BAD_REQUEST);
    }
...
//    }
    ...
    public final ResponseEntity<Object> handleThrowableGlobal(Throwable e, WebRequest request) throws Exception {
        LOGGER.error("handleThrowableGlobal EXCEPTION: {}, errorMsg:{}", e.getClass().getSimpleName(), e.getMessage(), e);
        return new ResponseEntity<>(Response.failure(CommonErrorEnum.INNER_ERROR), HttpStatus.INTERNAL_SERVER_ERROR);
    }

    @ExceptionHandler(Exception.class)
    public final ResponseEntity<Object> handleExceptionGlobal(Exception e, WebRequest request) throws Exception {
        LOGGER.error("handleExceptionGlobal EXCEPTION: {}, errorMsg:{}", e.getClass().getSimpleName(), e.getMessage(), e);
        return new ResponseEntity<>(Response.failure(CommonErrorEnum.INNER_ERROR), HttpStatus.INTERNAL_SERVER_ERROR);
    }

    @ExceptionHandler(HttpClientErrorException.class)
    public final ResponseEntity<Object> handleHttpClientErrorException(HttpClientErrorException e, WebRequest request) throws Exception {
        LOGGER.error("handleHttpClientErrorException EXCEPTION: {}, errorMsg:{}", e.getClass().getSimpleName(), e.getMessage(), e);
        return new ResponseEntity<>(Response.failure(CommonErrorEnum.INNER_ERROR), e.getStatusCode());
    }


    @ExceptionHandler(ThirdServerException.class)
    public final ResponseEntity<Object> handleThirdServerException(ThirdServerException e, WebRequest request) throws Exception {
        LOGGER.error("handleHttpClientErrorException EXCEPTION: {}, errorMsg:{}", e.getClass().getSimpleName(), e.getMessage(), e);

        return new ResponseEntity<>(Response.failure(e.errorInfo()), HttpStatus.INTERNAL_SERVER_ERROR);
    }
    ...
    protected ResponseEntity<Object> handleExceptionInternal(Exception ex, Object body, HttpHeaders headers,
        ...
        // METHOD_NOT_ALLOWED
        LOGGER.error("handleExceptionInternal, EXCEPTION:{}, status:{}", ex.getClass().getSimpleName(), status, ex);
