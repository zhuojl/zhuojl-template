...
public class ReqRespLoggingFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        ContentCachingRequestWrapper requestWrapper = new ContentCachingRequestWrapper(
                (HttpServletRequest) request, maxLogLength);
        ...
        LOGGER.info("common log request, method:{}, uri:{},\t requestParam:{}",
                ...
                JSONObject.toJSONString(requestWrapper.getParameterMap()));
        long timeMillStart = System.currentTimeMillis();

        chain.doFilter(requestWrapper, responseWrapper);

        LOGGER.info(
                "common log response, method:{}, uri:{}, time:{}, requestBody:{}, responseBody:{}",
                requestWrapper.getMethod(), requestWrapper.getRequestURI(),
                System.currentTimeMillis() - timeMillStart,
